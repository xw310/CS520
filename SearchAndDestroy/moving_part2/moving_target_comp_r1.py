...
from moving_target_travel_r1 import *
from moving_target_change_r1 import *
...
print(f'In moving situation, travel takes average {averstep_r1} step and change takes average {averstep_r2} step')
